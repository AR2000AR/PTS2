...
public class Piece {
	...
	public void faireTourner() // se d�clenchera avec un double clic et utilisera les rotations pr�faites en les appliquant � l'�tat actuel
	{
		...
		case 4 :
			...
			etatRotation=1;
			break;
		default: System.out.println("la rotation a �chou�e");
		}
