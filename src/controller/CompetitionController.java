...
public class CompetitionController extends PlateauController {
	...
	public void initialize() {
		if (imBtnPass == null) {
			imBtnPass = new Image(getClass().getResourceAsStream("image/imageBoutonPasserNiveau.png"));
		}
		try {
			Platform.runLater(() -> {
				...
				} catch (SAXException | IOException | ParserConfigurationException | JDOMException | NiveauInvalide
						| NiveauNonTrouve e1) {
